...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <h2>Featured Carousel Destination</h2>
            <div class="table-responsive">
                <table id="table1" class="table table-striped table-md table-hover table-bordered">
                    ...
                    <tbody>
                        <?php
                        $n = 0;
                        if (!empty($get_cft_query)) {
                            foreach ($get_cft_query as $img): $n++;
                        ?>
                                <tr>
                                    ...
                                    <td style="
                                        ...
                                        <b style="text-shadow: -1px -1px 0 white, 1px -1px 0 white, -1px 1px 0 white, 1px 1px 0 white;">
                                            <?= $img['cft_name'] ?>
                                        </b>
                                    </td>
                                    <td>
                                        <p style="text-align:justify;"><?= $img['cft_desc'] ?></p>
                                    </td>
                                    <td align="center">
                                        <button class="btn btn-primary btn-sm" title="UPDATE FEATURE" data-toggle="modal" data-target="#update<?= $img['cft_id'] ?>">
                                ...
                                <div class="modal fade" id="update<?= $img['cft_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog" style="max-width: 700px;">
                                        <div class="modal-content">
                                            <form action="../page/admin.php?function=updateDestination&subpage=homePage" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <textarea class="form-control auto-resize"
                                                                            ...
                                                                            required><?= $img['cft_desc'] ?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <hr><label><small style="color:red;">Note:</small> Fill-in the form below to change/update the Image and/or link for "More" button.</label>
                                                                    <hr>
                                                                </div>
                                                                <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="table-responsive">
                <table id="table2" class="table table-striped table-md table-hover table-bordered">
                    ...
                    <tbody>
                        <?php $n = 0;
                        foreach ($get_hft_query as $hft): $n++; ?>
                            <tr>
                                <td><?= $n ?></td>
                                <td style="
                            ...
                            <div class="modal fade" id="update_hft_<?= $hft['hft_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" style="max-width:700px;">
                                    <div class="modal-content">
                                        <form action="../page/admin.php?function=heroftBtn&subpage=homePage" method="post">
                                            <div class="modal-header">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control auto-resize"
                                                                        ...
                                                                        name="desc"
                                                                        oninput="autoResizeTextarea(this)"
                                                                        required><?= $hft['hft_desc'] ?></textarea>
                                                                </div>
                                                                <div class="col-sm-2" align="right">
                                                                    <b>Image Link:</b>
                                                                </div>
